...
public class CampfireOverhaulConfig {
    ...
    //This is campfireOverhaul-tweaked original variable.
    public static final ForgeConfigSpec.IntValue WORLDGEN_CAMPFIRES_LIFETIME;
    ...
    static {
        ...
        WORLDGEN_CAMPFIRES_LIFETIME = builder
                .comment("How long of a burn time should indirectly placed campfires have by default (in ticks, ticks = 1/20 of second) min=0, max=2147483647:")
                .defineInRange("worldgenCampfireslifeTime",  2000, 0, 2147483647);
